...
function EnhancedTableToolbar(props) {
  ...
  function deleteStudent(){
    props.handleDeleteStudent(props.selected)
    props.setSelected([]);
  }
...
export default function EnhancedTable(props) {
  ...
  return (
    <Box sx={{ width: '75%'}} align="center">
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar setSelected={setSelected} selected={selected} handleDeleteStudent={props.handleDeleteStudent} numSelected={selected.length} />
